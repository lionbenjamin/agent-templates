---
description: Fully autonomous pipeline from idea to implementation. Writes the spec, clarifies it, fixes gaps, then plans, implements, reviews (code + ASVS security), and QA — no manual gates.
---
...
28. **If verdict is NEEDS WORK**:
    - Read every Critical and High finding from the report.
